...
def home(request):
	return render(request, 'lfincsapp/home.html')

def about(request):
	return render(request, 'lfincsapp/about.html')

def blockchainfund(request):
	return render(request, 'lfincsapp/blockchainfund.html')

def liquidtoken(request):
	return HttpResponse('Liquid Token will be launched soon')

def bitcointradingfund(request):
	return render(request, 'lfincsapp/bitcointradingfund.html')

def earlystagetoken(request):
	return HttpResponse('Early Stage Token will be launched soon')

def stakingfund(request):
	return render(request, 'lfincsapp/stakingfund.html')

def energies(request):
	return render(request, 'lfincsapp/energies.html')

def sharestrading(request):
	return render(request, 'lfincsapp/sharestrading.html')

def agriculturalfund(request):
	return render(request, 'lfincsapp/agriculturalfund.html')

def nonfarmpayroll(request):
	return render(request, 'lfincsapp/nonfarmpayroll.html')

def renewableenergy(request):
	return render(request, 'lfincsapp/renewableenergy.html')

def investmentmanagement(request):
	return render(request, 'lfincsapp/investmentmanagement.html')

def financialservice(request):
	return render(request, 'lfincsapp/financialservice.html')

def portfoliomanagementservice(request):
	return render(request, 'lfincsapp/portfoliomanagementservice.html')

def financialadvising(request):
	return render(request, 'lfincsapp/financialadvising.html')

def pressrelease(request):
	return render(request, 'lfincsapp/about.html')

def faqs(request):
	return render(request, 'lfincsapp/faqs.html')

def terms(request):
	return render(request, 'lfincsapp/terms.html')

def privacy(request):
	return render(request, 'lfincsapp/privacy.html')

def otherpayment(request):
	return HttpResponse('Sorry but this method of payment is not available to you at the moment. Please, try using any available cryptocurrency of your choice, or contact support@lfincs.com for help')

def contact(request):
	return render(request, 'lfincsapp/contact.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'lfincsapp/main.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				email= username
				print(email)
				template= render_to_string('lfincsapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'lfincsapp/signin.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('lfincsapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('lfincsapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('lfincsapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		try:
			pass
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['support@lfincs.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'lfincsapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'lfincsapp/dashboard.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['support@lfincs.com'])
	...
	return render(request, 'lfincsapp/loan.html')

@login_required(login_url='signin')
def plans(request):
	plans= Plan.objects.all()
	context= {'plans':plans}
	return render(request, 'lfincsapp/plans.html', context)
...
def notifications(request):
	...
	return render(request, 'lfincsapp/notifications.html', context)
...
def admindashboard(request):
	...
	return render(request, 'lfincsapp/adminpage.html', context)
	...
	if request.method=='POST':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.lfincs.com/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.lfincs.com/dashboard"
			})
			...
			template= render_to_string('lfincsapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['support@lfincs.com'])
			except BadHeaderError:
				pass
			return redirect(generated_link)
	context={}
	return render(request, 'lfincsapp/deposit.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['support@lfincs.com'])
	...
	context={}
	return render(request, 'lfincsapp/withdrawal.html', context)
...
def history(request):
	...
	return render(request, 'lfincsapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'lfincsapp/pending_deposit.html', context)
...
def portfolio(request):
	...
	return render(request, 'lfincsapp/portfolio.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'lfincsapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'lfincsapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'lfincsapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'lfincsapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'lfincsapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('lfincsapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('lfincsapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'lfincsapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('lfincsapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'lfincsapp/account_settings.html', context)
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.email != client_username:
					...
					template= render_to_string('lfincsapp/creditMail.html', {'name':destination_client_account_info.email,
					...
					emailmessage.attach_alternative(template, 'text/html')
					#emailmessage.send()
					debit_template= render_to_string('lfincsapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						#send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['support@lfincs.com'])
					except BadHeaderError:
						pass
						#return HttpResponse('Something went wrong, please try again later')
...
def video_page(request):
	...
	return render(request, 'lfincsapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('lfincsapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
